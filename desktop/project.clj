(defproject ideas-game "0.0.1-SNAPSHOT"
  :description "If you touch an idea it will explode."
  ...
  :aot [ideas-game.core.desktop-launcher]
  :main ideas-game.core.desktop-launcher)
